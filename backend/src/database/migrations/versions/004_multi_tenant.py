...
def _agregar_tenant_id_a_tablas(op, inspector, tables):
    ...
    tablas_con_tenant = ['usuarios', 'personas', 'ganado', 'potrero', 'vacunacion', 'qr', 'revision']
...
def _asignar_tenant_defecto_restantes(op):
    ...
    tablas = ['ganado', 'potrero', 'vacunacion', 'qr', 'revision']
    for tabla in tablas:
        op.execute(f"""
...
def _hacer_tenant_id_not_null(op, inspector, tables):
    ...
    tablas_not_null = ['ganado', 'potrero', 'vacunacion', 'qr', 'revision']
