...
potrero_bp.route('/tipos-pasto', methods=['POST'])(PotreroController.crear_tipo_pasto)
potrero_bp.route('/tipos-pasto/<int:pasto_id>', methods=['PUT'])(PotreroController.actualizar_tipo_pasto)
