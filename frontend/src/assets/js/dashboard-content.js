...
export default {
  ...
  methods: {
    ...
    async _cargarEstadisticasSuperAdmin() {
      ...
      if (selectedTenantId) {
        await this._cargarGanado();
        await this._cargarPotreros();
      } else {
    ...
    async _cargarEstadisticasAdminNormal() {
    ...
    async cargarEstadisticas() {
      ...
      try {
        if (this.isSuperAdmin) {
          await this._cargarEstadisticasSuperAdmin();
        } else {
          await this._cargarEstadisticasAdminNormal();
        }
