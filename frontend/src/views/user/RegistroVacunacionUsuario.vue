          ...
          <div class="card-body p-0">
            <div class="table-responsive">
              <table class="table table-hover mb-0">
                <caption class="visually-hidden">Tabla de registros de vacunación mostrando ID animal, nombre, tipo de vacuna, fechas, responsable, estado y acciones disponibles</caption>
                ...
                <tbody>
                  <tr v-for="v in vacunaciones" :key="v.id">
                    ...
                    <td>
                      <button class="btn btn-sm btn-outline-success me-1" @click="verVacunacion(v.id)"><i class="fas fa-eye"></i></button>
...
<script>
import registroVacunacionUsuario from '../../assets/js/registro-vacunacion-usuario.js';

export default registroVacunacionUsuario;
</script>
